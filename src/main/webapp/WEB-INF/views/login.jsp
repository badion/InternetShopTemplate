...
<c:if test="${pageContext.request.userPrincipal.name != null}">
	<div class="logined">
		...
		<a
			href="https://www.facebook.com/logout.php?next=http://localhost:8080/InternetShop/login&access_token=CAAVZCgw3HTq4BAEqZCKOcYlEtX4lyPaJJSAPM4XTTg706gD6x5kZBbODbFc7q75ZCGyNJvnMaruc2x48i9LH5ZAiMF0tmpiU1ZC3uZCvmfXWk3oLkcxtn6Pc5jTbXHSyXTsZBnWCXdc9tddHcwfHUG86A0PZCjpQCqZC07JvHaAuVeulLxBst0xp3JsvoBLDgn4nZBsXZCmA5xfXpJopNU7BDPt1">Logout
			from facebook</a>
